...
use Inlead\Easyscreen\SearchBundle\NanoSOAPClient;
...
class AlmaClient {
  ...
  public function request($method, $params = array(), $check_status = TRUE) {
    try {
      ...
      // the HTTP client out.
      $request = $this->curl_request($this->base_url . $method, $params, array('secure_socket_transport' => 'sslv3'));
      ...
      throw new AlmaClientHTTPError('Smth is wrong with ALMA URL or access to it: ' . $e->toString);
      return new DOMDocument();
    }
  }

  private function curl_request($url, $params = null, $headers = null) {
    if ($params != null) {
      $get = array();
    ...
    $curl_options = array(
      CURLOPT_URL => $url . ($params != null ? '?' . $params : ''),
