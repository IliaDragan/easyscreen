...
class SearchController extends Controller
{
    ...
    {
//         $this->parameters['callback'] = $request->query->get('callback');
//         $this->parameters['query'] = $request->query->get('query');
//         $this->parameters['offset'] = intval($request->query->get('offset'));
//         $this->parameters['limit'] = intval($request->query->get('limit'));
//         $this->parameters['facets'] = $request->query->get('facets');
//         $this->parameters['faust'] = $request->query->get('recordId');
...
//         $result = str_replace("'", "\'", $result);
        ...
        if (! empty($this->parameters['callback'])) {
            $this->parameters['callback'] = preg_replace('/[^\w]/', '', $this->parameters['callback']);
